cask "riela" do
  ...
  version "0.1.52"
  sha256 "91a0115d2a8b21de422cc2e4a844e0b5e47a3a27f3f32b0598530535a66cab70"

  url "https://github.com/tacogips/riela/releases/download/v0.1.52/riela-#{version}-#{arch}.dmg"
  name "riela"
