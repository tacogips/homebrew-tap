class Ign < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/ign/releases/download/v#{version}/ign-#{version}-darwin-arm64.tar.gz"
      sha256 "43efaceb9cebd8d012fe3ba7ab242173c7187927903180890981d325bca136fb"
    else
      url "https://github.com/tacogips/ign/releases/download/v#{version}/ign-#{version}-darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/ign/releases/download/v#{version}/ign-#{version}-linux-arm64.tar.gz"
      sha256 "18fe91127c5b4ad6f7c15dd997506b819462d99b69f3f09b249b6f4809417eb7"
    else
      url "https://github.com/tacogips/ign/releases/download/v#{version}/ign-#{version}-linux-x64.tar.gz"
