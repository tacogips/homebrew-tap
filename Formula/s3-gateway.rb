class S3Gateway < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/s3-gateway/releases/download/v0.1.0/s3-gateway-0.1.0-darwin-arm64.tar.gz"
      sha256 "ccfba2104bcd571df2a0dac7f70497691defe096fda67b15ae3055817c8b3bb1"
    else
      url "https://github.com/tacogips/s3-gateway/releases/download/v0.1.0/s3-gateway-0.1.0-darwin-x64.tar.gz"
