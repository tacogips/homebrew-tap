class DocumentGateway < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/document-gateway/releases/download/v0.1.0/document-gateway-0.1.0-darwin-arm64.tar.gz"
      sha256 "133acedebb0145d414d49d823ded7c4a32c16c56778224c961252fc3074ccaf7"
    else
      url "https://github.com/tacogips/document-gateway/releases/download/v0.1.0/document-gateway-0.1.0-darwin-x64.tar.gz"
