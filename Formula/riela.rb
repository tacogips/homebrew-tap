class Riela < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tacogips/riela/releases/download/v0.1.43/riela-0.1.43-darwin-arm64.tar.gz"
      sha256 "c0d27917d1ab94049368757a46c525f16be0f153e9eb0a9580225097b5756f99"
    end
  end
