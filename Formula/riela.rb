class Riela < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tacogips/riela/releases/download/v0.1.49/riela-0.1.49-darwin-arm64.tar.gz"
      sha256 "23d83c74c678aeca9b47ff8366b3d6bcd9cc787a880572b5146caeb125cb868a"
    end
  end
