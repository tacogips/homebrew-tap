class Riela < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tacogips/riela/releases/download/v0.1.52/riela-0.1.52-darwin-arm64.tar.gz"
      sha256 "e48635901c6e670e6893bacc03dce230761778d217a8e47795be0620c23bbda1"
    end
  end
