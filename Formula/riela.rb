class Riela < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tacogips/riela/releases/download/v0.1.50/riela-0.1.50-darwin-arm64.tar.gz"
      sha256 "884c5e138748c44cd5097055ae738d5a6de6c03403ec1e8539c65b8c9c472d1a"
    end
  end
