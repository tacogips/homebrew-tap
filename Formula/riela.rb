class Riela < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tacogips/riela/releases/download/v0.1.48/riela-0.1.48-darwin-arm64.tar.gz"
      sha256 "c5388105e98e0de9ef3ea762e9ac4519a8aefeb3f785d4926bb96e8a335266bc"
    end
  end
