class Riela < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tacogips/riela/releases/download/v0.1.55/riela-0.1.55-darwin-arm64.tar.gz"
      sha256 "5b0234fef46f4df687f897c430496cc82a8f161658a70e725580259b51feebc5"
    end
  end
