class CalendarGateway < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/calendar-gateway/releases/download/v0.1.3/calendar-gateway-0.1.3-darwin-arm64.tar.gz"
      sha256 "1cd0704bee770cef42e002565f3f54d753d00b036256a7a718fbb291e86b2217"
    else
      url "https://github.com/tacogips/calendar-gateway/releases/download/v0.1.3/calendar-gateway-0.1.3-darwin-x64.tar.gz"
